...
#   value = [for i in azurerm_virtual_network.myvnet : i.name]
# }

# output "vnet_name_2_ip" {
#   description = "sample2"
#   value = [for i,j in azurerm_virtual_network.myvnet : i]
...
output "sample" {
  ...
  value = {for i,j in azurerm_virtual_network.myvnet : i => j.bgp_community}
